...
// Comprehensive CRUD test with correct schema
...
async function testCompleteCrud() {
  console.log('🔧 Testing Complete CRUD Operations (Fixed)...\n');
  ...
  try {
    ...
    console.log('🎡 TESTING ATTRACTIONS CRUD (Fixed):');
    
    // CREATE
    console.log('\n1. 📝 Testing CREATE...');
    const newAttraction = {
      attraction: 'Test Attraction Fixed',
      emirates: 'Dubai',
      price: 99,
    ...
    // ========== HOTELS CRUD TESTING ==========
    console.log('\n\n🏨 TESTING HOTELS CRUD (Fixed Schema):');
    
    // CREATE (without is_active field)
    console.log('\n1. 📝 Testing CREATE...');
    const newHotel = {
      name: 'Test Hotel Fixed',
      stars: 4,
      price_range_min: 200,
      price_range_max: 400,
      category: 'Business',
    ...
    if (successRate === 100) {
      console.log('🎉 Perfect! All CRUD operations are now working correctly!');
